...
('Saðlýk Profesyoneli', 'rabia', 'cad', 'rb.23@example.com', '2323'),
('Hasta Yakýný', 'Hacer', 'Cadirci', 'hcd@example.com', '2323'),
('Saðlýk Profesyoneli', 'Medine', 'Þa', 'medi@example.com', '23223');
...
VALUES
(1, '2022-07-10', '08:00:00', 1),
(2, '2019-11-22', '09:00:00', 2);

----bir ilaç kullanýmý için birden fazla bildirim gönderilebilir
INSERT INTO SaglikSistemi.Takvim_Bildirimler (Kullaným_ID, Kullaným_Tarihi, Kullaným_Saati, Durum_ID)
VALUES
(1, '2016-07-18', '08:00:00', 2);

---bir bildirim farklý ilaç kullanýmlarý için gönderilebilir
INSERT INTO SaglikSistemi.Takvim_Bildirimler (Kullaným_ID, Kullaným_Tarihi, Kullaným_Saati, Durum_ID)
VALUES
(2, '2020-05-21', '08:00:00', 1);